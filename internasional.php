...
<div class=" text-white h-20 bg-neutral-800">
    ...
    <a href="internasional.php" class="m-3 font-medium text-xl mt-6 text-red-700">INTERNASIONAL</a>
...
<div class=" mt-5 ml-12">
    <h1 class=" font-bold text-4xl">Internasional</h1>
...
$ambil=mysqli_query($koneksi, "SELECT * FROM detail_berita WHERE jenis_berita='internasional' ORDER BY tanggal DESC");
