...
<div class=" text-white h-20 bg-neutral-800">
    ...
    <a href="olahraga.php" class="m-3 font-medium text-xl mt-6 text-red-700">OLAHRAGA</a>
...
<div class=" mt-5 ml-12">
    <h1 class=" font-bold text-4xl">Olahraga</h1>
...
$ambil=mysqli_query($koneksi, "SELECT * FROM detail_berita WHERE jenis_berita='olahraga' ORDER BY tanggal DESC");
