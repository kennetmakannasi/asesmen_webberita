...
<div class=" text-white h-20 bg-neutral-800">
    ...
    <a href="nasional.php" class="m-3 font-medium text-xl mt-6 text-red-700">NASIONAL</a>
...
<div class=" mt-5 ml-12">
    <h1 class=" font-bold text-4xl">Nasional</h1>
...
$ambil=mysqli_query($koneksi, "SELECT * FROM detail_berita WHERE jenis_berita='nasional' ORDER BY tanggal DESC");
