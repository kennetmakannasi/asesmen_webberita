...
<div class=" text-white h-20 bg-neutral-800">
    ...
    <a href="lainnya.php" class="m-3 font-medium text-xl mt-6 mr-11 text-red-700">LAINNYA</a>
...
<div class=" mt-5 ml-12">
    <h1 class=" font-bold text-4xl">Lainnya</h1>
...
$ambil=mysqli_query($koneksi, "SELECT * FROM detail_berita WHERE jenis_berita='lainnya' ORDER BY tanggal DESC");
